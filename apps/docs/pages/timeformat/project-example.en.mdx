...
<Tabs items={['npm', 'yarn', 'pnpm', 'bun']}>
  <Tab>
    <Steps>
      ...
      ```js showLineNumbers copy filename="index.js"
        ...
        const t = new TimeFormat(); // TimeFormat instance
        ...
        // Test: Convert from milliseconds
        ...
        console.log('DailyAt callback executed!\n');
        });
  ...
  <Tab>
    <Steps>
      ...
      <!-- The rest of the content is identical to npm -->
    </Steps>
  </Tab>
...
<Callout type="info" emoji="ℹ️">
    You can use **TimeFormat** to create time-based events, such as countdowns, repeating callbacks, scheduling callbacks, etc.
</Callout>
