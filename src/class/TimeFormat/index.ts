export class TimeFormat {
  convertToMilliseconds(time: string): number {
    ...
    if (!match) {
      throw new Error('Formato inválido.'); // Corrigir a mensagem de erro aqui, se necessário.
    }
    ...
    default: throw new Error('Unidade inválida.'); // Aqui você pode ter que corrigir a mensagem de erro
    }
  }
